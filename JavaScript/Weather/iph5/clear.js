// clear condition iph5
// UniAW6.2 By Ian Nicoll with credit to Dacal

if (where == "day") {  // Start daytime
...
{ //Start Nighttime
	...
	var container9 = document.getElementById("starsBGContainer");
	container9.appendChild(createAbackground());
}  // End of nighttime
...
function createABalloon() {
    ...
    big_balloonDiv.style.webkitAnimationName = "fade, float";
...
function createBBalloon() {
    ...
    small_balloonDiv.style.webkitAnimationName = "fade, float";
