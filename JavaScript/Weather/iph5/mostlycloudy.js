...
container6.appendChild(createAlight());

if (where == "day") {
	if (Show_Birds == true) {
		var container7 = document.getElementById("birdsContainer");
		container7.appendChild(createBbird());
		}
		
	if (V_Formation_Birds == true) {
			var container8 = document.getElementById("birdsContainer");
			container8.appendChild(createAbird());
		}
